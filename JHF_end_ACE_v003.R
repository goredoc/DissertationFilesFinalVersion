...
sourceCpp("BALBA.cpp")
source("JHF_end_BALBA2_v003.R")
source("JHF_end_priors_init_v003.R")
...
sourceCpp("BALBA.cpp")
source("JHF_end_BALBA2_v003.R")
source("JHF_end_priors_reduced_v003.R")
source("JHF_end_DEMCMC_v003.R")
...
for (i in (I - 1):num_monte_carlo) {
  ...
  cat("\n ", i, "  ")
  if (i %% 100 == 0) save.image("JHF_end_v003_centsave.RData")
  # Hyper level
  phi[,, i] <- phi[,, i - 1]
...
I <- i
toc <- tictoc::toc()
save.image("JHF_end_v003_A.RData")
...
save.image("JHF_end_v003_B.RData")
...
png("phiScatter_JHF_end_ACE_v003.png",width=7.5, height=7.5, units="in",res=72)
pairs.panels(t(phi_scatter[c(1,3,5,7,9,11),]))
dev.off()
...
save.image("JHF_end_v003_C.RData")
#--------------------------- Prediction
# Synth_data <- list()
# s <- 15
