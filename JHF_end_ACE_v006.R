...
sourceCpp("BALBA.cpp")
source("JHF_end_BALBA2_v006.R")
source("JHF_end_priors_init_v006.R")
...
sourceCpp("BALBA.cpp")
source("JHF_end_BALBA2_v006.R")
source("JHF_end_priors_reduced_v006.R")
source("JHF_end_DEMCMC_v006.R")
...
for (i in (I - 1):num_monte_carlo) {
  ...
  cat("\n ", i, "  ")
  if (i %% 100 == 0) save.image("JHF_end_v006_centsave.RData")
  # Hyper level
  phi[,, i] <- phi[,, i - 1]
...
I <- i
toc <- tictoc::toc()
save.image("JHF_end_v006_A.RData")
...
save.image("JHF_end_v006_B.RData")
...
png("phiScatter_JHF_end_ACE_v006.png",width=7.5, height=7.5, units="in",res=72)
...
save.image("JHF_end_v006_C.RData")
#--------------------------- Prediction
# Synth_data <- list()
# s <- 15
