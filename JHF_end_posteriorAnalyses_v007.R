...
meanHyperChainPlot(phi,phi_names,1,IDTAG,hyper_params_starts,estimation_space,TRUE,TRUE,10)
meanHyperChainPlot(phi,phi_names,1,IDTAG,hyper_params_starts,estimation_space,TRUE,FALSE,10)
