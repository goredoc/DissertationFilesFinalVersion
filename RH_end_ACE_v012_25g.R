# purpose of RH_end_ACE_v012_25g.R
# parameter recovery
# rho = .25
# 16 participants are simulated
# everything else identical to RH_end_ACE_v002
# parameter recovery for BALBA
# with GORE updating rule
...
sourceCpp("BALBA.cpp")
source("RH_end_BALBA2_v012_25g.R")
source("RH_end_priors_init_v012_25g.R")
...
sourceCpp("BALBA.cpp")
source("RH_end_BALBA2_v012_25g.R")
source("RH_end_priors_reduced_v012_25g.R")
source("RH_end_DEMCMC_v012_25g.R")
...
for (i in (I - 1):num_monte_carlo) {
  ...
  cat("\n ", i, "  ")
  if (i %% 100 == 0) save.image("RH_end_v012_25g_centsave.RData")
  # Hyper level
  phi[,, i] <- phi[,, i - 1]
...
save.image("RH_end_v012_25g_A.RData")
rho1a = phi[13,1,1:i]
...
save.image("RH_end_v012_25g_B.RData")
...
save.image("RH_end_v012_25g_C.RData")
#--------------------------- Prediction
# Synth_data <- list()
# s <- 15
