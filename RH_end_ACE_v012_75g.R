# purpose of RH_end_ACE_v012_75g.R
# using Gore updating rule
# and BALBA
# with rho = .75
# and 16 cases
...
sourceCpp("BALBA.cpp")
source("RH_end_BALBA2_v012_75g.R")
source("RH_end_priors_init_v012_75g.R")
...
sourceCpp("BALBA.cpp")
source("RH_end_BALBA2_v012_75g.R")
source("RH_end_priors_reduced_v012_75g.R")
source("RH_end_DEMCMC_v012_75g.R")
...
for (i in (I - 1):num_monte_carlo) {
  ...
  cat("\n ", i, "  ")
  if (i %% 100 == 0) save.image("RH_end_v012_75g_centsave.RData")
  # Hyper level
  phi[,, i] <- phi[,, i - 1]
...
save.image("RH_end_v012_75g_A.RData")
rho1a = phi[13,1,1:i]
...
save.image("RH_end_v012_75g_B.RData")
...
save.image("RH_end_v012_75g_C.RData")
#--------------------------- Prediction
# Synth_data <- list()
# s <- 15
